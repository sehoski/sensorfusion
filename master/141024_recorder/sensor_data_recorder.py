...
class RadarCameraNode(Node):
    def __init__(self):
        ...
        self.cap.set(cv2.CAP_PROP_FRAME_WIDTH, 1280)  # 해상도: 너비 1280
        self.cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 800)   # 해상도: 높이 800
        self.cap.set(cv2.CAP_PROP_FPS, 30)             # 프레임 속도: 30fps
        ...
        # 타이머 설정
        self.create_timer(1 / 20, self.radar_callback)  # 레이더 데이터 처리 (20Hz)
