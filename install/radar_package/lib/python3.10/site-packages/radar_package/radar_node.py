...
class RadarNode(Node):
    def __init__(self):
        ...
        # 2D 시각화를 위한 초기화
        self.fig, (self.ax_polar, self.ax_3d, self.ax_2d) = plt.subplots(1, 3, figsize=(18, 6))
        self.ax_polar = plt.subplot(131, projection='polar')
        ...
        # 3D 위치 시각화를 위한 초기화
        self.ax_3d = plt.subplot(132, projection='3d')
        ...
        # Range, Azimuth, Elevation 시각화를 위한 초기화
        self.ax_2d = plt.subplot(133, projection='3d')
        self.scatter_2d = self.ax_2d.scatter([], [], [], c='red', marker='o')
    ...
    def update_visualization(self, new_data):
        ...
        self.scatter_2d._offsets3d = (range_data, azimuth_data, elevation_data)
